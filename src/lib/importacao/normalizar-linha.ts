...
const ALIASES: Record<string, string[]> = {
  numeroOs:       ['#', 'numero_os', 'numeroos', 'os', 'numero'],
  ...
  horaSaida:      ['horasaida', 'hora_saida'],
  dataFinalizacao:['datafinalizacao', 'data_finalizacao', 'datafinal', 'data_final'],
  instalador:     ['instalador', 'tecnico_nome', 'technician'],
  login:          ['login'],
  cliente:        ['cliente'],
  endereco:       ['endereco'],
  bairro:         ['bairro'],
